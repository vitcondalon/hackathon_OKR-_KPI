  ...
  return (
    <div className="ui-shell flex items-center justify-center">
      <div className="ui-surface ui-page-enter max-w-lg rounded-3xl p-10 text-center">
        ...
        <Link to="/workspace" className="ui-soft-hover mt-5 inline-block rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(36,107,255,0.3)] hover:bg-brand-600">
          Quay về workspace
        </Link>
      </div>
    </div>
